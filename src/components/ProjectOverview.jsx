...
const ProjectOverview = () => {
  ...
  return (
    currentWorkspace && (
      <div className="w-full bg-white dark:bg-zinc-950 dark:bg-linear-to-br dark:from-zinc-800/70 dark:to-zinc-900/50 border border-zinc-200 dark:border-zinc-800 rounded-lg overflow-hidden transition-all duration-200">
        ...
        <div>
          {projects.length === 0 ? (
            <div className="p-8 sm:p-12 text-center">
              <div className="w-14 h-14 sm:w-16 sm:h-16 mx-auto mb-4 bg-zinc-200 text-zinc-600 dark:bg-zinc-800 dark:text-zinc-500 rounded-full flex items-center justify-center">
                <FolderOpen size={30} />
              </div>
              ...
              <button
                ...
                className="mt-4 px-4 py-2 text-sm bg-linear-to-br from-blue-500 to-blue-600 text-white rounded hover:opacity-90 transition"
              >
                ...
                >
                  <div className="flex items-start justify-between mb-3 gap-3">
                    <div className="flex-1 min-w-0">
                      <h3 className="font-semibold text-zinc-800 dark:text-zinc-300 mb-1 wrap-break-word">
                        {project.name}
                      </h3>

                      <p className="text-sm text-zinc-600 dark:text-zinc-400 line-clamp-2 wrap-break-word">
