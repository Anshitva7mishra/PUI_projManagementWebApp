...
const CreateProjectDialog = ({ isDialogOpen, setIsDialogOpen }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/20 dark:bg-black/60 backdrop-blur flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-xl w-full max-w-lg text-zinc-900 dark:text-zinc-200 relative max-h-[90vh] overflow-y-auto p-6">
        <button
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-3 py-2 rounded h-20 dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-700 text-sm"
            />
          </div>
          ...
          <div>
            ...
            >
              ...
              {currentWorkspace?.members
                ?.filter(
                  (member) => !formData.team_members.includes(member.user.email)
                )
                .map((member) => (
                  <option key={member.user.email} value={member.user.email}>
                    {member.user.email}
          ...
          <div className="flex justify-end gap-3 pt-2 text-sm">
            ...
            <button
              ...
              className="px-4 py-2 rounded bg-linear-to-br from-blue-500 to-blue-600 text-white"
            >
